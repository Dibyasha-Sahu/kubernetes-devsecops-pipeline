...
## GitHub Repository
     ...
     Repository: kubernetes-devsecops-pipeline 
...
Created Docker image:
  ...
  - devsecops-flask-app:1.0


Build command:

        docker build -t devsecops-flask-app:1.0 .  
...
- Directory: ~/kubernetes-devsecops-pipeline
- GHCR: ghcr.io/dibyasha-sahu/kubernetes-devsecops-pipeline
